...
RSpec.describe ProjetosController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested projeto as @projeto" do
      projeto = Projeto.create! valid_attributes
      get :show, params: {id: projeto.to_param}, session: valid_session
  ...
  describe "GET #new" do
    it "assigns a new projeto as @projeto" do
      ...
      expect(assigns(:projeto)).to be_a_new(Projeto)
    end
  end
  ...
  describe "GET #edit" do
    it "assigns the requested projeto as @projeto" do
      projeto = Projeto.create! valid_attributes
      get :edit, params: {id: projeto.to_param}, session: valid_session
      expect(assigns(:projeto)).to eq(projeto)
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested projeto" do
        projeto = Projeto.create! valid_attributes
        put :update, params: {id: projeto.to_param, projeto: new_attributes}, session: valid_session
        projeto.reload
      ...
      it "assigns the requested projeto as @projeto" do
        projeto = Projeto.create! valid_attributes
        put :update, params: {id: projeto.to_param, projeto: valid_attributes}, session: valid_session
        expect(assigns(:projeto)).to eq(projeto)
      end
    ...
    context "with invalid params" do
      it "assigns the projeto as @projeto" do
        projeto = Projeto.create! valid_attributes
        put :update, params: {id: projeto.to_param, projeto: invalid_attributes}, session: valid_session
        expect(assigns(:projeto)).to eq(projeto)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested projeto" do
      projeto = Projeto.create! valid_attributes
      expect {
        delete :destroy, params: {id: projeto.to_param}, session: valid_session
      }.to change(Projeto, :count).by(-1)
    end
    ...
    it "redirects to the projetos list" do
      projeto = Projeto.create! valid_attributes
      delete :destroy, params: {id: projeto.to_param}, session: valid_session
      expect(response).to redirect_to(projetos_url)
    end
  end
